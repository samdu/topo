...
8. **Revoke stops it.** Press Revoke beside the address and the token stops working at once; within five seconds the page clears the board, the transcript and everything it had cached, and says the screen is not registered. The screen stays on the roster and the hub does not quietly serve it again: it offers Serve again instead, which is a fresh decision and a fresh address. The revoked one never comes back.
