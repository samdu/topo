...
// samdu/experiments `topo-mascot-swift` at 91139e8 (the Swift port of `topo-mascot-engine`'s
// JavaScript at e93fe1f), copied here unchanged; the suite holds it to golden frames that
// JavaScript rendered (Tests/TopoMascotTests/golden.json, made by that experiment's
// `oracle/golden.mjs`). Foundation only; the iOS app draws him on the composer's glass.
let package = Package(
    name: "TopoMascot",
