  ...
  launch)
    case "$FAKE_LAUNCH" in
      ...
      guest-answered) say "userland: booted"; say "guest: starting Claude Code, a fresh session"
                      say "guest turn 1 sent: a"; say "guest turn 1 model: claude-haiku-4-5-20251001, session S1"
      ...
      guest-one-failed) say "guest turn 1 model: claude-haiku-4-5-20251001, session S1"
                        say "guest turn 1 failed in 12.00 s: the process ended mid-turn"
                        say "guest turn 2 model: claude-haiku-4-5-20251001, session S1"
                        say "guest turn 2 answered in 1.20 s: yes"; say "guest turn done"; exec sleep 600 ;;
      guest-abandoned) say "guest turn 1 model: claude-haiku-4-5-20251001, session S1"
                       say "guest turn 1 abandoned after 15.00 s"; say "guest turn 2 model: claude-haiku-4-5-20251001, session S1"
                       say "guest turn 2 answered in 1.20 s: yes"; say "guest turn done"; exec sleep 600 ;;
      guest-error) say "guest turn error: Claude Code did not start"; say "guest turn done"; exec sleep 600 ;;
      guest-opus) say "guest turn 1 model: claude-opus-5, session S1"; say "guest turn 1 answered in 3.00 s: ok"
                  say "guest turn 2 model: claude-opus-5, session S1"; say "guest turn 2 answered in 1.00 s: ok"
                  say "guest turn done"; exec sleep 600 ;;
      guest-one-short) say "guest turn 1 model: claude-haiku-4-5-20251001, session S1"
